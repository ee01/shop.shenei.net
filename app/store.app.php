...
class StoreApp extends StorebaseApp
{
    function index()
    {
		...
		$this->assign('store_views',$this->_get_store_views($id));	//Add By 01
		$this->_update_s_views($id);	//Add By 01
    ...
    function article()
    {
		...
		$this->assign('store_views',$this->_get_store_views($article['store_id']));	//Add By 01
